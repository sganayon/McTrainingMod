...
public class SpawnerScreen extends Screen {
    ...
    private ResourceLocation GUI = new ResourceLocation(McTrainingMod.MODID, "textures/gui/spawner_gui.png");
